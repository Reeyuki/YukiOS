...
export const descriptionMap = {
  ...
  pttr:
    "Paint the Town Red is a chaotic voxel brawler by South East Games, released in 2021. Players fight through destructible arenas packed with enemies, using fists, blades and brutal finishers in endlessly replayable sandbox carnage.",
